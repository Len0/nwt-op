...
AdOffer.create([{title: 'Reklama TV', subtitle: 'Najjeftinije na planeti', description: 'Primetime reklama na TV Amna', price: 50.23, unit: 'min', date_start: Date.today.to_s, date_end: (Date.today + 10).to_s, is_hidden: false, views_count: 0,max_duration:2, user_id: 4, ad_type_id: 1},
                {title: 'Reklama Radio', subtitle: 'Najjeftinije u eteru', description: 'Na radiju Kameleon', price: 20.00, unit: 'min', date_start: Date.today.to_s, date_end: (Date.today + 10).to_s, is_hidden: false,views_count:0, user_id: 4, max_duration:2, ad_type_id: 2},
                {title: 'Reklama TV Druga', subtitle: 'Najjeftinije na planeti 2', description: 'Primetime reklama na TV Kiseljak', price: 12.45, unit: 'min', date_start: Date.today.to_s, date_end: (Date.today + 10).to_s, is_hidden: false,views_count:0,max_duration:2, user_id: 4, ad_type_id: 1},
                ...
                {title: 'Reklama Novine', subtitle: 'Najjeftinije na papiru', description: 'Kod Fahre', price: 2.25, unit: 'duz', date_start: Date.today.to_s, date_end: (Date.today + 10).to_s, is_hidden: false,views_count:0,max_duration:2, user_id: 4, ad_type_id: 3},
                {title: 'Reklama Plakat', subtitle: 'Najjeftinije po slici', description: 'Europlakat', price: 4.00, unit: 'sat', date_start: Date.today.to_s, date_end: (Date.today + 10).to_s, is_hidden: false,views_count:0, max_duration:2, user_id: 4, ad_type_id: 4}
               ])